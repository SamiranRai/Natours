...
// we need to implement a method to hash the password!
...
userSchema.methods.createEmailVerificationToken = function () {
    const random4DigitNumber = Math.floor(Math.random() * 9999) + 1000;
    ...
    //log to the console
    console.log({ randomNumber: random4DigitNumber }, { hashed4DigitNumber: hashed4DigitNumber });
